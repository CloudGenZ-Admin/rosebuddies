    ...
    <section id="how-it-works" className="py-32 px-6 md:px-12 bg-brand-light relative z-30">
      <div className="max-w-5xl mx-auto relative">
        <div className="text-center mb-24 relative">
          <h2 className="text-5xl md:text-6xl font-serif text-brand-dark relative inline-block">
            ...
            <span className="relative inline-block mt-2">
              ...
              <svg className="absolute -bottom-4 -left-4 w-[110%] h-6 -z-10 text-brand-pink" viewBox="0 0 200 20" fill="none">
        ...
        <div className="relative flex">
          <div className="hidden md:block absolute left-8 top-10 bottom-0 w-1 bg-dashed border-l-4 border-dashed border-brand-pink-dark z-0"></div>

          <div className="w-full flex flex-col gap-8">
            <div className="sticky top-24 pt-4 pb-12 md:pb-24 h-auto z-10 w-full md:w-[90%]">
              <div className="relative bg-brand-cream rounded-3xl p-8 md:p-14 border-4 border-brand-dark shadow-[8px_8px_0px] shadow-brand-pink-dark transform -rotate-1 transition-transform hover:rotate-0">
                <div className="absolute -top-6 -left-6 md:-left-12 w-16 h-16 bg-brand-pink border-4 border-brand-dark rounded-full flex items-center justify-center text-3xl font-black font-serif text-brand-dark shadow-[4px_4px_0px] shadow-brand-dark z-20">1</div>
            ...
            <div className="sticky top-32 pt-4 pb-12 md:pb-16 h-auto z-20 w-full md:w-[90%] md:ml-[5%]">
              <div className="relative bg-brand-yellow rounded-3xl p-8 md:p-14 border-4 border-brand-dark shadow-[8px_8px_0px] shadow-brand-primary transform rotate-1 transition-transform hover:rotate-0">
                ...
                <div className="absolute -top-3 right-20 w-16 h-6 bg-brand-pink-dark/60 backdrop-blur-sm -rotate-6 z-20"></div>
                <div className="pl-4 md:pl-8">
                  <h3 className="text-3xl md:text-4xl font-serif mb-4 text-brand-dark">Join a Meet & Greet <span className="text-brand-primary text-2xl block mt-2">($25 One-Time Experience)</span></h3>
            ...
            <div className="sticky top-40 pt-4 pb-12 h-auto z-30 w-full md:w-[90%] md:ml-[10%]">
              <div className="relative bg-brand-secondary rounded-3xl p-8 md:p-14 border-4 border-brand-dark shadow-[8px_8px_0px] shadow-brand-dark transform -rotate-1 transition-transform hover:rotate-0">
                <div className="absolute -top-6 -left-6 md:-left-12 w-16 h-16 bg-brand-yellow border-4 border-brand-dark rounded-full flex items-center justify-center text-3xl font-black font-serif text-brand-dark shadow-[4px_4px_0px] shadow-brand-dark z-20">3</div>
                <div className="absolute -top-3 right-1/4 w-24 h-6 bg-brand-cream/40 backdrop-blur-sm rotate-2 z-20"></div>
                <div className="pl-4 md:pl-8">
                  <h3 className="text-3xl md:text-4xl font-serif mb-6 text-brand-cream">Choose Your Path</h3>
                  
                  <div className="mb-6">
                    <h4 className="text-2xl font-black text-brand-yellow mb-2">Friendship Clubs <span className="text-xl font-normal block md:inline md:ml-2">(Starting at $40/month)</span></h4>
                    <p className="text-xl font-medium text-brand-cream/90 leading-relaxed font-sans">
                      Join a recurring social circle where friendships can grow naturally through shared interests and regular gatherings.
                    </p>
                  </div>
                  
                  <div className="text-center font-black text-brand-cream/50 text-2xl my-4">OR</div>
                  
                  <div>
                    <h4 className="text-2xl font-black text-brand-pink mb-2">Curated Experiences <span className="text-xl font-normal block md:inline md:ml-2">($250 Experience Pass)</span></h4>
                    <p className="text-xl font-medium text-brand-cream/90 leading-relaxed font-sans">
            ...
            <div className="sticky top-48 pt-4 pb-12 h-auto z-40 w-full md:w-[90%] md:ml-[15%]">
              <div className="relative bg-brand-pink rounded-3xl p-8 md:p-14 border-4 border-brand-dark shadow-[8px_8px_0px] shadow-brand-dark transform rotate-1 transition-transform hover:rotate-0">
                <div className="absolute -top-6 -left-6 md:-left-12 w-16 h-16 bg-brand-secondary border-4 border-brand-dark rounded-full flex items-center justify-center text-3xl font-black font-serif text-brand-cream shadow-[4px_4px_0px] shadow-brand-dark z-20">4</div>
                <div className="absolute -top-3 right-10 w-24 h-6 bg-brand-yellow/60 backdrop-blur-sm -rotate-2 z-20"></div>
                <div className="pl-4 md:pl-8">
