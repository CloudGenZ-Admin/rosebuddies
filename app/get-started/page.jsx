...
// Reusable SVG for the seamless wave (from your provided WaitlistForm)
...
// =========================================
// WAITLIST FORM COMPONENT (Integrated as requested)
// =========================================
          ...
          <form onSubmit={handleSubmit} className="text-2xl md:text-3xl leading-[2.5] font-serif text-brand-dark relative z-10">
            ...
            <div className="mt-16 text-center">
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                ...
                {/* Secondary Button -> Scrolls up to Vibe Check */}
                <button 
                  type="button"
